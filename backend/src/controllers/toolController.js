...
const getToolByField = asyncHandler(async(req , res , next) => {
...
.sort({averageRating : -1}) // hight rating first
.select('name description url fiels averageRating numbersOfReviews')
...
export  {
 ...
 createTool , getTool , getAllTool , updateTool , deleteTool , getToolByField
